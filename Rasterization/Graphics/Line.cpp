...
Kie::Line::Line(Kie::Point p1, Kie::Point p2, Texture& texture):
lineColor(-1,-1,-1,true),vertex({std::move(p1),std::move(p2)}),useTexture(true),texture(texture) {}
...
Kie::Line::Line(Kie::Point p1, Kie::Point p2, Kie::Color c):lineColor(c),vertex({std::move(p1),std::move(p2)}),texture() {
}
